...
from weibocrawler import get_search_results
from weibocrawler import proc_search_results
from weibocrawler import output_search_results
...
def main():
	...
	get_search_results.main(request)
